...
<div class="modal-content">
    ...
    <br>
        <form class="col-12"  method="post" action="form.php" enctype="multipart/form-data" >
...
if(isset($_REQUEST["register"])){
    ...
    $cpass = mysqli_real_escape_string($con,$_REQUEST["cpass"]);
   
    
    if($pass == $cpass){
        $insert = "INSERT INTO registration (user_name) VALUES ('$name')";
